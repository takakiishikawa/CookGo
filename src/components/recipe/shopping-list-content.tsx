...
export function ShoppingListContent({ recipe }: ShoppingListContentProps) {
  ...
  return (
    <div className="w-full bg-[oklch(98%_0.01_70)] rounded-[18px] p-6">
      ...
      <div className="flex justify-center items-center gap-2.5 mt-2.5">
        <span className="text-[11px] text-[oklch(48%_0.02_50)]">Serves</span>
